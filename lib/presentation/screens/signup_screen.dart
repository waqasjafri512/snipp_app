                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    filled: true,
                                    prefixIcon: Icon(Icons.person_outline_rounded, color: theme.primaryStart.withOpacity(0.5), size: 18),
                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    fillColor: isDark ? Colors.white.withOpacity(0.05) : Colors.grey[50],
                                    filled: true,
                                    prefixIcon: Icon(Icons.alternate_email_rounded, color: theme.primaryStart.withOpacity(0.5), size: 18),
                                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide.none),
                                  ),
                                ),
                              ],
